...
3. Stage au parquet, section criminalité organisée — **mention sobre uniquement dans la timeline /a-propos, jamais en argument commercial central**
4. Avocat fondateur PMS Avocats (prestation de serment 6 novembre 2023)
5. Chargé d'enseignement en droit des sociétés — Institut catholique de Paris

**Asset narratif central** : « cabinet à taille humaine + réseau pluridisciplinaire **Le Paraclet** ». C'est le couple « attention boutique / force collective » qui structure toute la communication du cabinet. **NE PAS** mettre en avant le passage parquet comme accroche commerciale — c'était un stage rapide, pas un poste de magistrat.
...
1. **Cabinet à taille humaine** — accessibilité, suivi personnalisé, accès direct au Conseil
2. **Réseau pluridisciplinaire Le Paraclet** — force d'équipe collective sur dossiers complexes (avocats, juristes, experts-comptables, huissiers, associations partenaires)
3. **L'enseignement universitaire** (Institut catholique de Paris) — rigueur académique
4. **Spécialisation lanceurs d'alerte** — niche peu couverte, expertise pointue
5. **Couverture transversale** affaires + pénal des affaires + pénal général — réponse complète sur les problématiques d'entreprise

**Ne PAS valoriser** : le passage parquet (stage court, pas un poste), la présence média perso de Mathieu (Ligne Droite, Radio Courtoisie, X, YouTube — registre politique qui ne s'aligne pas avec la cible B2B affaires du site).
